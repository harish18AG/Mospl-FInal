...
class Product {
  ...
  factory Product.fromMap(Map<String, dynamic> map) {
    return Product(
      ...
      price: (map['price'] as num).round(),
      oldPrice: (map['oldPrice'] as num).round(),
      discountPercentage: (map['discountPercentage'] as num).round(),
      rating: (map['rating'] as num).toDouble(),
      reviewCount: (map['reviewCount'] as num).round(),
      stock: (map['stock'] as num).round(),
      sku: map['sku'].toString(),
      shortDescription: (map['shortDescription'] ?? map['description']).toString(),
      description: map['description'].toString(),
      specifications: _stringMap(map['specifications']),
      material: map['material'].toString(),
      size: map['size'].toString(),
      color: map['color'].toString(),
      deliveryInfo: map['deliveryInfo'].toString(),
