...
function specificationValue(specifications, key) {
  return specifications[key] || NOT_SPECIFIED;
}

function sizeFromSpecs(specifications) {
  const height = specificationValue(specifications, 'Height');
  const width = specificationValue(specifications, 'Width');
  if (height === NOT_SPECIFIED || width === NOT_SPECIFIED) return NOT_SPECIFIED;
...
function normalizeSpecifications(record) {
  return {
    ...
    Height: specificationValue(record.specifications, 'Height'),
    Width: specificationValue(record.specifications, 'Width'),
    'Card Slots': specificationValue(record.specifications, 'Card Slots'),
    'No. of Pocket': specificationValue(record.specifications, 'No. of Pocket'),
    Pattern: specificationValue(record.specifications, 'Pattern'),
    'No. of Compartments': specificationValue(record.specifications, 'No. of Compartments'),
